...
namespace InstaSharp.Endpoints
{
    ...
    public class Users : InstagramApi
    {
        ...
        /// <returns>Media Response</returns>
        public async Task<MediasResponse> RecentSelf(string maxId, string minId, int? count, DateTime? minTimestamp, DateTime? maxTimestamp)
        {
            AssertIsAuthenticated();
            var userId = await GetSelf();
            return await Recent(userId.Data.Id.ToString(), maxId, minId, count, minTimestamp, maxTimestamp);
        }
