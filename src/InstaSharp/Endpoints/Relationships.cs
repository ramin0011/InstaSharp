...
namespace InstaSharp.Endpoints
{
    ...
    public class Relationships : InstagramApi
    {
        ...
        public async Task<UsersResponse> Follows()
        {
            AssertIsAuthenticated();
           // var userId = await new Users(InstagramConfig, OAuthResponse).GetSelf();
            return await Follows((await new Users(InstagramConfig, OAuthResponse).GetSelf()).Data.Id, null);
        }
